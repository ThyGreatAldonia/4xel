...
print(startup)
print("Made by The Federation Of Aldonia")
print("[!] Running PREMIUM version of G240, Make sure to have an activation key! [!]")
...
╔═════════════════════════════╦═════════════════════════════╦═════════════════════════════╗
║ [-1-] Delete all channels   ║ [-4-] Ban All Members       ║                             ║       
